...
#include <memory>
#include "../../automated_workplace_of_confectioner/generalwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GeneralWindow_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(3, 27, 19) // "on_EditData_clicked"

    },
    "GeneralWindow\0firstWindow\0\0"
    "on_EditData_clicked"
};
...
void GeneralWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GeneralWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->firstWindow(); break;
        case 1: _t->on_EditData_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GeneralWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GeneralWindow::firstWindow)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GeneralWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_GeneralWindow.data,
    qt_meta_data_GeneralWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GeneralWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GeneralWindow.stringdata0))
...
// SIGNAL 0
void GeneralWindow::firstWindow()
{
